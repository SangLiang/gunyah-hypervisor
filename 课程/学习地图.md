...
| 主战场 | ARM64 EL2 |
| 推荐实验平台 | QEMU |
| 当前进度 | 第 1–13 课已按 [大纲](大纲.md) 写完（L0 + L1）；第 14 课起未写。旧 8 课在 `第一版/` |
...
第 1–13 课已按新课号写完。第 14 课起仍待写；下表「现读」在未写完前指向旧文件（`第一版/`）。

| 新课 | 阶段 | 核心知识点 | 现读 |
|------|------|------------|------|
| 1 | L0 预备 | Type-1；RM / PVM / SVM | [第 1 课](第1课.md) |
| 2 | L0 预备 | EL0 / EL1 / EL2 各跑什么 | [第 2 课](第2课.md) |
| 3 | L0 预备 | Stage-1：VA → 页表 → PA | [第 3 课](第3课.md) |
| 4 | L0 预备 | 中断 vs 异常/陷入 | [第 4 课](第4课.md) |
| 5 | L0 预备 | 线程；VCPU 也是线程 | [第 5 课](第5课.md) |
| 6 | L1 | 入口汇编；MMU/TLS 没好前不能进普通 C | [第 6 课](第6课.md) |
| 7 | L1 | `boot.ev` 总序；`trigger_*` 是广播 | [第 7 课](第7课.md) |
| 8 | L1 | `.ev` subscribe；优先级排出顺序 | [第 8 课](第8课.md) |
| 9 | L1 | 一页 RAM：partition → memdb | [第 9 课](第9课.md) |
| 10 | L1 | idle 是半成品，更早就建了 | [第 10 课](第10课.md) |
| 11 | L1 | preempt 启动锁；`cpu_cold` 骨架 | [第 11 课](第11课.md) |
| 12 | L1 | CPULOCAL；`cpu_warm` 通电 | [第 12 课](第12课.md) |
| 13 | L1 | RootVM `vcpu_poweron` → idle | [第 13 课](第13课.md) |
| 14–17 | L2 | 线程对象；FPRR；切换；三把锁 | [第一版第 5 课](第一版/第5课.md) |
| 18–21 | L3 | memdb；memextent；Stage-2；7 步串讲 | [第一版第 6 课](第一版/第6课.md) |
| 22–24 | L4 | 进 hyp；注入 ICH_LR；WFI | [第一版第 7 课](第一版/第7课.md) |
| 25–27 | L5 | 两条 HVC；CapID；doorbell（L6 点方向） | [第一版第 8 课](第一版/第8课.md) |
...
- [ ] 🟢 能讲清 Stage-1：VA → 页表 → PA（先不管 Stage-2）
- [ ] 🟢 能区分设备 IRQ 和指令触发的异常/陷入
- [ ] 🟢 能说：线程是可调度实体；VCPU 在 hyp 里也是一种线程
...
**目标**：弄清 Type-1、EL、Stage-1 页表、中断 vs 陷入、线程/VCPU，以及本仓库在整套生态里的位置。
...
**完成标准**：能自己画出：硬件 → Gunyah(EL2) → RootVM(RM) → PVM/SVM；能用自己的话讲清 Stage-1、中断 vs 陷入、VCPU 也是线程。

**对应课文**：[第 1 课](第1课.md)、[第 2 课](第2课.md)、[第 3 课](第3课.md)、[第 4 课](第4课.md)、[第 5 课](第5课.md)
...
**对应课文**：[第 6 课](第6课.md)～[第 13 课](第13课.md)
...
**对应课文**：大纲第 14–17 课（现读 [第一版第 5 课](第一版/第5课.md)）
...
**对应课文**：大纲第 18–21 课（现读 [第一版第 6 课](第一版/第6课.md)）
...
**对应课文**：大纲第 22–24 课（现读 [第一版第 7 课](第一版/第7课.md)）
...
**对应课文**：大纲第 25–27 课（现读 [第一版第 8 课](第一版/第8课.md)）
...
**对应课文**：不单独成课；方向见大纲第 27 课（现读 [第一版第 8 课](第一版/第8课.md) 末尾）
...
1. 从 [第 1 课](第1课.md) 开始，按 [大纲](大纲.md) 课号往下。第 14 课起正文未写完时，用地图「现读」列对照 `第一版/`。
2. 读：`README.md` → `docs/terminology.md` → `docs/build.md`
3. 预备课（第 1–5 课）不跟启动链；从第 6 课再跟 `init_el2.S` → `boot_cold_init()`
