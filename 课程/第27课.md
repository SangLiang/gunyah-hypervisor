...
| 方向 | 入口 |
|------|------|
| VirtIO | [virtio 第 1 课](virtio/第1课.md)；代码从 `hyp/vm/virtio*` |
...
到这里，大纲上的 L0–L5 主线已经按课走完。L6 按兴趣选一条即可。若跟 VirtIO，从 [virtio 第 1 课](virtio/第1课.md) 开始（大纲见 [大纲-virtio.md](大纲-virtio.md)）。也可以按能力纵切（安全隔离 / 执行 / 中断 / API）再跟一遍。
